...
//   }
    ...
    const BaharBetBox = () => {
        ...
        if (walletBalance >= selectedCoins) {
            ...
            handleBetUpdate("tailValue", selectedCoins, setBaharBetValue);
        } else {
            toast.error("Insufficient balance!");
        }
    };
        ...
        <>
            ...
            <div >
                <div className={`flex items-center justify-between h-[3.22rem] px-2`}>
                    <p className="!text-white flex items-center justify-between "><MdArrowBackIos onClick={() => navigate('/')} />  Head Tail</p>
                    <p >
                        <NavLink size="small" variant="contained" to='/headsntails/history' className="btn-register"><BiHistory size={24} /></NavLink>
                    </p>
                </div>
                <div
                ...
                >
                    <div className="z-50 w-full h-full flex items-center justify-center overflow-hidden relative">
                        {startAnimationFireCard && (
                            <div
                                className={`absolute w-72 bottom-12 right-10 `}
                            >
                                <img
                    ...
                    <div className='absolute w-full font-bold grid grid-cols-3 px-2 bottom-[47vh] xsm:bottom-[45vh]'>
                        <div className='col-span-1 text-white w-full flex items-center justify-start'>
                            ...
                            >
                                <p className="text-xs text-center">&nbsp;{snoResultDataAnnouncement}</p>
